...
- [Part II: The Production Flow — From Collator to Relay Chain](#part-ii-the-production-flow--from-collator-to-relay-chain)
  ...
  - [25. Collation Submission Pipeline: From Candidate Receipt to Validator Advertisement](#25-collation-submission-pipeline-from-candidate-receipt-to-validator-advertisement)
    - [25.1. The Overseer: Central Message Router](./collation-submission-pipeline.md#251-the-overseer-central-message-router)
    - [25.2. CollationGenerationSubsystem: Receiving SubmitCollation](./collation-submission-pipeline.md#252-collationgenerationsubsystem-receiving-submitcollation)
    - [25.3. handle\_submit\_collation: Preparing the Collation](./collation-submission-pipeline.md#253-handle_submit_collation-preparing-the-collation)
    - [25.4. construct\_and\_distribute\_receipt: Building the Candidate](./collation-submission-pipeline.md#254-construct_and_distribute_receipt-building-the-candidate)
    - [25.5. Erasure Coding and the Erasure Root](./collation-submission-pipeline.md#255-erasure-coding-and-the-erasure-root)
    - [25.6. CollatorProtocolSubsystem: Distributing the Collation](./collation-submission-pipeline.md#256-collatorprotocolsubsystem-distributing-the-collation)
    - [25.7. Validator Discovery: determine\_our\_validators](./collation-submission-pipeline.md#257-validator-discovery-determine_our_validators)
  ...
  - [28. The Trie and Pruning](#28-the-trie-and-pruning)
    - [Trie Nodes Are Not Overwritten](#trie-nodes-are-not-overwritten)
    - [Pruning](#pruning)
  - [29. Complete Production Cycle Summary](#29-complete-production-cycle-summary)
- [Part III: Supplementary Concepts](#part-iii-supplementary-concepts)
  - [30. Weight System: The 2D Model](#30-weight-system-the-2d-model)
  ...
  - [31. Events System](#31-events-system)
  ...
  - [32. Header Structure and Digest](#32-header-structure-and-digest)
...
## 25. Collation Submission Pipeline: From Candidate Receipt to Validator Advertisement
...
> **Deep Dive**: For the complete code analysis with all 12 subsections, see [Collation Submission Pipeline](./collation-submission-pipeline.md).

**Subsections:**
- [25.1. The Overseer: Central Message Router](./collation-submission-pipeline.md#251-the-overseer-central-message-router)
- [25.2. CollationGenerationSubsystem: Receiving SubmitCollation](./collation-submission-pipeline.md#252-collationgenerationsubsystem-receiving-submitcollation)
- [25.3. handle_submit_collation: Preparing the Collation](./collation-submission-pipeline.md#253-handle_submit_collation-preparing-the-collation)
- [25.4. construct_and_distribute_receipt: Building the Candidate](./collation-submission-pipeline.md#254-construct_and_distribute_receipt-building-the-candidate)
- [25.5. Erasure Coding and the Erasure Root](./collation-submission-pipeline.md#255-erasure-coding-and-the-erasure-root)
- [25.6. CollatorProtocolSubsystem: Distributing the Collation](./collation-submission-pipeline.md#256-collatorprotocolsubsystem-distributing-the-collation)
- [25.7. Validator Discovery: determine_our_validators](./collation-submission-pipeline.md#257-validator-discovery-determine_our_validators)
...
## 26. Persistence to RocksDB: execute_and_import_block
...
## 27. try_commit_operation: The Atomic Write
...
## 29. Complete Production Cycle Summary
...
## 32. Header Structure and Digest
